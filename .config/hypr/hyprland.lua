...
hl.on("hyprland.start", function () 
  hl.exec_cmd("waybar & hyprpaper & hypridle & vorta")
  hl.exec_cmd("hyprsunset && hyprctl hyprsunset identity")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(757994db)", "rgba(757994db)"}, angle = 45 },
            inactive_border = "rgba(404352aa)",
        },
